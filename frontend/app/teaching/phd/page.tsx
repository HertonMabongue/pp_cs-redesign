          ...
          <div className="container-narrow mx-auto px-6 pb-12">
            ...
            >
              ...
              >
                ...
                <span style={{ color: "rgba(202,162,88,0.7)" }}>/</span>
                <span style={{ color: "#caa258" }}>PhD</span>
              </nav>
        ...
        <div className="container-narrow mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              >
                <p>
                  Our PhD in Computer Science is a{" "}
                  <strong style={{ color: "#61223b" }}>
                    three-year degree based solely on dissertation work
                  </strong>
                  . The goal is to conduct original, cutting-edge research in a
                  particular, specialised field of Computer Science. The student
                  must demonstrate his/her ability to propose, plan, conduct,
                  and publish a research project.
                </p>
                <p>
                  You need the agreement of a staff member that will supervise
                  your PhD thesis. Browse through our{" "}
                  <Link
                    href="/research"
                ...
                <p>
                  The admission requirements for a PhD in Computer Science is a{" "}
                  <strong style={{ color: "#61223b" }}>
            ...
            >
              <Image
                src="https://files.su.ac.za/public/faculty-arts-and-social-sciences/images/2026-02/pg.jpg"
